...
void sort_system(){
    ...
    unsigned long long int arr9[10]; unsigned long long int arr10[10]; int limit; int i; int j; char ch;
    int size = sizeof(arr1)/sizeof(arr1[0]); int mid = size/2; int whilecon = 1;
