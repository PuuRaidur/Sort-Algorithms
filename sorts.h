...
while(choice != 'B' && choice != 'b' && choice != 'S' && choice != 's' && 
    choice != 'M' && choice != 'm' && choice != 'I' && choice != 'i'){
    printf("\nB or b for bubble sort, S or s for selection sort, M or m for merge sort, I or i for insertion sort.\n");
    printf("Choice:");
    scanf(" %c", &choice);
...
while(choice != 'I' && choice != 'i' && choice != 'D' &&
    choice != 'd' && choice != 'C' && choice != 'c' &&
    choice != 'E' && choice != 'e'){
    printf("\nWhich array do you want to give values to and sort?\n");
    printf("I or i for integer array, D or d for double array, C or c character array.\n");
    printf("But if you want to exit the prorgram: E or e\n");
    printf("Choice:");
    scanf(" %c", &choice);
    if(choice == 'I' || choice == 'i'){
        unsintinput();
