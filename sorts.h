...
void printcharindec(unsigned char arr[], int size){
    for(int i = 0; i < size; i++){
        printf("  %d.%d", i+1, arr[i]);
    }
}

void printcharinoct(unsigned char arr[], int size){
    for(int i = 0; i < size; i++){
        printf("  %d.%o", i+1, arr[i]);
    }
}

void printcharinhex(unsigned char arr[], int size){
    for(int i = 0; i < size; i++){
        printf("  %d.%x", i+1, arr[i]);
    }
}

void charindec_oct_hex(){
    unsigned char arr[10];
    int size = sizeof(arr)/sizeof(arr[0]);
    ...
    chprintarr(arr, size);
    printf("\nDecimal array: ");
    printcharindec(arr, size);
    printf("\nOctal array: ");
    printcharinoct(arr, size);
    printf("\nHexadecimal array: ");
    printcharinhex(arr, size);
}
/**/